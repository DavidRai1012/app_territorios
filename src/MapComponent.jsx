  ...
  return (
    ...
    >
      <div style={{
        ...
        <div style={{ width: '0', height: '0', borderLeft: '10px solid transparent', borderRight: '10px solid transparent', borderBottom: '20px solid #ef4444', marginTop: '5px' }}></div>
        <div style={{ fontSize: '14px', fontWeight: 'bold', marginTop: '2px', color: '#333' }}>N</div>
      </div>
    </div>
  );
}
